...
(cl:defmethod cl:initialize-instance :after ((m <drive_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidart_gap_finding-msg:<drive_param> is deprecated: use lidart_gap_finding-msg:drive_param instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidart_gap_finding-msg:velocity-val is deprecated.  Use lidart_gap_finding-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidart_gap_finding-msg:angle-val is deprecated.  Use lidart_gap_finding-msg:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<drive_param>)))
  ...
  "lidart_gap_finding/drive_param")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'drive_param)))
  "Returns string type for a message object of type 'drive_param"
  "lidart_gap_finding/drive_param")
